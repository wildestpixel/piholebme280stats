...
bme280.sea_level_pressure = 1042
...
#        draw.text((x, y), "DNS Queries: {}".format(DNSQUERIES), font=font, fill="#FF00FF")
        ...
        draw.text((x, y), "Temp: %0.1f C" % bme280.temperature, font=font, fill="#FFFFFF")
        y += font.getsize(str(bme280.temperature))[1]
        draw.text((x, y), "Humidity: %0.1f %%" % bme280.humidity, font=font, fill="#FFFFFF")
        y += font.getsize(str(bme280.humidity))[1]
        draw.text((x, y), "Pres.: %0.1f hPa" % bme280.pressure, font=font, fill="#FFFFFF")
        y += font.getsize(str(bme280.pressure))[1]
        draw.text((x, y), "Alt.: %0.2f metres" % bme280.altitude, font=font, fill="#FFFFFF")
        y += font.getsize(str(bme280.altitude))[1]
    else:
        draw.text((x, y), IP, font=font, fill="#FFFF00")
        y += font.getsize(IP)[1]
